...
func (handler *DakibotHandler) doHandle(r *http.Request) (*horizon.TransactionSuccess, error) {
...
func (handler *DakibotHandler) loadResult(address string) (*horizon.TransactionSuccess, error) {
