...
// be submitted to the backing rover-core process, as well as looking up the status
...
// Submitter represents the low-level "submit a transaction to rover-core"
// provider.
type Submitter interface {
	// Submit sends the provided transaction envelope to rover-core
