// Package txsub provides the machinery that orbit uses to submit transactions to
// the rover network and track their progress.  It also helps to hide some of the
