...
clientData:
  laboratoryUrl: https://www.rover.network/laboratory/#explorer?resource=effects&endpoint=for_operation
---
...
```sh
curl "https://orbit-testnet.rover.network/operations/77309415424/effects"
```
