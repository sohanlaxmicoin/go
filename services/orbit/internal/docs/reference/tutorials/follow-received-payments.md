...
This tutorial shows how easy it is to use Orbit to watch for incoming payments on an [account](../../reference/resources/account.md)
using JavaScript and `EventSource`.  We will eschew using [`js-rover-sdk`](https://github.com/rover/js-rover-sdk), the
...
> If you need a reliable streaming connection please use our [SDK](https://github.com/rover/js-rover-sdk).
