...
directly reflected in the [ledger](https://www.rover.network/developers/learn/concepts/ledger.html) or [history](https://github.com/rover/rover-core/blob/master/docs/history.md), as [transactions](https://www.rover.network/developers/learn/concepts/transactions.html) and [operations](https://www.rover.network/developers/learn/concepts/operations.html) are.
