...
GOTOP="$( cd "$DIR/../../../../../../../.." && pwd )"
PACKAGES=$(find $GOTOP/src/github.com/stellar/go/services/orbit/internal/test/scenarios -iname '*.rb' -not -name '_common_accounts.rb')
# PACKAGES=$(find $GOTOP/src/github.com/stellar/go/services/orbit/internal/test/scenarios -iname 'kahuna.rb')
...
go generate github.com/stellar/go/services/orbit/internal/test/scenarios
# go test github.com/stellar/go/services/orbit/internal/ingest
