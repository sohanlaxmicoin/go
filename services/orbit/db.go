...
import (
	...
	"github.com/stellar/go/services/orbit/internal/db2/schema"
...
var dbCmd = &cobra.Command{
	Use:   "db [command]",
	Short: "commands to manage orbit's postgres db",
}

var dbBackfillCmd = &cobra.Command{
	Use:   "backfill [COUNT]",
	Short: "backfills orbit history for COUNT ledgers",
...
var dbInitCmd = &cobra.Command{
	...
	Long:  "init initializes the postgres database used by orbit.",
	Run: func(cmd *cobra.Command, args []string) {
