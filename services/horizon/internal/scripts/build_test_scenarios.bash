...
GOTOP="$( cd "$DIR/../../../../../../../.." && pwd )"
PACKAGES=$(find $GOTOP/src/github.com/rover/go/services/horizon/internal/test/scenarios -iname '*.rb' -not -name '_common_accounts.rb')
# PACKAGES=$(find $GOTOP/src/github.com/rover/go/services/horizon/internal/test/scenarios -iname 'kahuna.rb')
...
go generate github.com/rover/go/services/horizon/internal/test/scenarios
# go test github.com/rover/go/services/horizon/internal/ingest
