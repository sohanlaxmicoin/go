...
import (
	...
	. "github.com/rover/go/services/horizon/internal/test/trades"
...
func TestTradeActions_IndexRegressions(t *testing.T) {
	t.Run("Regression:  https://github.com/rover/go/services/horizon/internal/issues/318", func(t *testing.T) {
		ht := StartHTTPTest(t, "trades")
		defer ht.Finish()
