...
1. Clone horizon's source:  `git clone https://github.com/rover/go.git && cd go`
2. Download external dependencies: `glide install`
3. Build the binary: `go install github.com/rover/go/services/horizon`
